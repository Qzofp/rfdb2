...
--
-- Host: localhost:3306
-- Generation Time: May 27, 2024 at 03:52 PM
...
(5, 0, 'BK#1254', '2023-08-24 15:40:46', 15, 'crypto', 'BitKudo Exchange'),
...
(9, 0, 'Test #2', '2020-11-28 15:34:55', 16, 'crypto', ''),
...
INSERT INTO `tbl_cryptocurrenties` (`id`, `name`, `symbol`, `website`) VALUES
(1, 'Bitcoin', 'BTC', 'https://bitcoin.org'),
(2, 'Ethereum', 'ETH', 'https://ethereum.org');
...
(24, 27, 'Cryptorekeningen,Datum,Storting,Onttrekking,Dienst,Rekening,Beschrijving'),
(25, 28, 'Cryptomunten,Naam,Crypto,Website'),
(26, 29, 'Wallets,Dienst,Crypto,Beschrijving');
...
(24, 27, 'Crypto Accounts,Date,Deposit,Withdrawal,Service,Account,Description'),
(25, 28, 'Crypto Currencies,Name,Crypto,Website'),
...
(1, '2024-04-30', 1, '9999.99', '1234.05', '6789.00', 4, 'Dit is een test regel. Test Test Test.'),
...
(2, 'finance', '{\"page\": \"true\", \"show\": \"true\", \"scale\": \"months\", \"start\": \"2001\", \"theme\": {\"color\": \"#ffd700\"}}'),
(3, 'stock', '{\"page\": \"true\", \"show\": \"true\", \"scale\": \"quarters\", \"start\": \"2024\", \"theme\": {\"color\": \"#228b22\"}}'),
(4, 'savings', '{\"page\": \"true\", \"show\": \"true\", \"scale\": \"months\", \"start\": \"2024\", \"theme\": {\"color\": \"#4169e1\"}}'),
...
(2, 'Rizzo', '5cc955b91289a48f2bb3a1d31cf4badfe74e2381d69ca68d6a7db63e23871098', '2024-05-27 15:28:48', '2024-05-27 13:25:06'),
...
INSERT INTO `tbl_wallets` (`id`, `aid`, `cid`, `description`) VALUES
(1, 6, 1, 'Trezor BTC Wallet'),
(2, 6, 2, 'Trezor ETH Wallet'),
(3, 5, 1, 'BitKudo Exchange BTC Wallet');
