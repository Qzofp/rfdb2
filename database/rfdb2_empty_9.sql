...
--
-- Host: localhost:3306
-- Generation Time: Jan 08, 2024 at 01:45 PM
...
CREATE TABLE `tblFirm` (
  `id` int NOT NULL,
  `firmname` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_grp` int DEFAULT NULL,
  `description` varchar(250) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sumtype` enum('1','2','3') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(10, 13, 'Aanmelden,Gebruikersnaam,Wachtwoord,Het aanmelden is mislukt!'),
...
(10, 13, 'Sign In,Username,Password,Login failed! '),
...
(1, 'Rizzo', '!Welcome01', NULL, NULL),
(2, 'Admin', 'P@ssw0rd', NULL, NULL);
