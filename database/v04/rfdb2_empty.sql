...
--
-- Host: localhost:3306
-- Generation Time: Sep 08, 2025 at 02:31 PM
...
(87, 0, 57, 1, '0.03679673'),
(88, 0, 58, 4, '0.05308090'),
(89, 0, 58, 3, '0.05045750'),
(90, 0, 57, 2, '0.01864570'),
(91, 0, 59, 1, '0.03679673'),
(92, 0, 60, 4, '0.05308090'),
(93, 0, 60, 3, '0.05045750'),
(94, 0, 59, 2, '0.01864570');
...
(7, '2024-01-08', 5, '48.00', NULL, 'Van betaalrekening'),
(8, '2024-01-08', 6, '49.00', NULL, 'Van betaalrekening'),
(9, '2024-03-04', 5, '48.00', NULL, 'Van betaalrekening'),
(10, '2024-03-04', 6, '49.00', NULL, 'Van betaalrekening'),
(11, '2024-05-06', 5, '48.00', NULL, 'Van betaalrekening'),
(12, '2024-05-06', 6, '49.00', NULL, 'Van betaalrekening'),
(13, '2024-07-08', 5, '48.00', NULL, 'Van betaalrekening'),
(14, '2024-07-08', 6, '49.00', NULL, 'Van betaalrekening'),
(15, '2024-09-09', 5, '48.00', NULL, 'Van betaalrekening'),
(16, '2024-09-09', 6, '49.00', NULL, 'Van betaalrekening'),
(17, '2024-11-04', 5, '48.00', NULL, 'Van betaalrekening'),
(18, '2024-11-04', 6, '49.00', NULL, 'Van betaalrekening');
...
(2, '2024-01-08', 4, '25.00', NULL, 'Van betaalrekening'),
(3, '2024-01-08', 3, '50.00', NULL, 'Van betaalrekening'),
(4, '2024-04-08', 4, '25.00', NULL, 'Van betaalrekening'),
(5, '2024-07-08', 4, '25.00', NULL, 'Van betaalrekening'),
(6, '2024-07-08', 3, '50.00', NULL, 'Van betaalrekening'),
(7, '2024-10-07', 4, '25.00', NULL, 'Van betaalrekening'),
(8, '2024-10-07', 3, '50.00', NULL, 'Van betaalrekening'),
(9, '2024-12-09', 4, '25.00', NULL, 'Van betaalrekening'),
(10, '2024-12-09', 3, '50.00', NULL, 'Van betaalrekening');
...
(1, 'Admin', '9e71af2675ef9d36c6d23b737d0be7c1bd828c6cea289f91f7199478d8bcf46e', '2025-09-08 14:04:54', '2025-09-06 13:53:04');
...
(140, 0, '2025-04-21', 2, '354.00'),
(141, 0, '2025-04-21', 1, '454.00'),
(142, 0, '2025-04-21', 4, '554.00'),
(143, 0, '2025-04-21', 3, '654.00'),
(144, 0, '2025-04-21', 5, '754.00'),
(145, 0, '2025-04-21', 6, '854.00'),
(146, 0, '2025-05-19', 2, '365.00'),
(147, 0, '2025-05-19', 1, '465.00'),
(148, 0, '2025-05-19', 4, '565.00'),
(149, 0, '2025-05-19', 3, '665.00'),
(150, 0, '2025-05-19', 5, '765.00'),
(151, 0, '2025-05-19', 6, '864.00');
...
(57, '2025-04-21', 1, '73104.00'),
(58, '2025-04-21', 2, '1404.00'),
(59, '2025-05-19', 1, '75005.00'),
(60, '2025-05-19', 2, '1605.00');
...
CREATE TABLE `tbl_wallets` (
  ...
  `aid` int NOT NULL,
  `cid` int NOT NULL,
  `color` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
  `description` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
