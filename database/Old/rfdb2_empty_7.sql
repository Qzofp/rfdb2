...
(3, 'Pages', 'index.html,sheet.html#finance,sheet.html#stock,sheet.html#savings,sheet.html#crypto,settings.html,logout.php'),
(4, 'Titles', NULL),
(5, 'Months', NULL),
(6, 'Quarters', NULL),
(7, 'Year', NULL),
...
(10, 13, 'Aanmelden,Gebruikersnaam,Wachtwoord');
...
(10, 13, 'Sign In,Username,Password');
