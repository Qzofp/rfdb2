...
--
-- Host: localhost:3306
-- Generation Time: Jun 23, 2024 at 12:15 PM
...
(21, 1, 'TST#3', '2024-06-21 12:31:11', 16, 'crypto', 'Test 3');
...
(2, 'Rizzo', '5cc955b91289a48f2bb3a1d31cf4badfe74e2381d69ca68d6a7db63e23871098', '2024-06-23 11:55:40', '2024-06-22 11:56:28'),
...
--
-- Triggers `tbl_wallets`
--
DROP TRIGGER IF EXISTS `trg_hidewallet`;
DELIMITER $$
CREATE TRIGGER `trg_hidewallet` AFTER UPDATE ON `tbl_wallets` FOR EACH ROW BEGIN
